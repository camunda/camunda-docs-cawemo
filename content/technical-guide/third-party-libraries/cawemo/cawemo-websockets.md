...
- [laravel/framework@v11.30.0](https://github.com/laravel/framework.git) (MIT)
- [laravel/prompts@v0.3.1](https://github.com/laravel/prompts.git) (MIT)
- [laravel/reverb@v1.4.2](https://github.com/laravel/reverb.git) (MIT)
- [laravel/serializable-closure@v1.3.5](https://github.com/laravel/serializable-closure.git) (MIT)
...
- [nunomaduro/termwind@v2.2.0](https://github.com/nunomaduro/termwind.git) (MIT)
...
- [symfony/clock@v7.1.6](https://github.com/symfony/clock.git) (MIT)
- [symfony/console@v7.1.6](https://github.com/symfony/console.git) (MIT)
- [symfony/css-selector@v7.1.6](https://github.com/symfony/css-selector.git) (MIT)
- [symfony/deprecation-contracts@v3.5.0](https://github.com/symfony/deprecation-contracts.git) (MIT)
- [symfony/error-handler@v7.1.6](https://github.com/symfony/error-handler.git) (MIT)
- [symfony/event-dispatcher@v7.1.6](https://github.com/symfony/event-dispatcher.git) (MIT)
- [symfony/event-dispatcher-contracts@v3.5.0](https://github.com/symfony/event-dispatcher-contracts.git) (MIT)
- [symfony/finder@v7.1.6](https://github.com/symfony/finder.git) (MIT)
- [symfony/http-foundation@v7.1.6](https://github.com/symfony/http-foundation.git) (MIT)
- [symfony/http-kernel@v7.1.6](https://github.com/symfony/http-kernel.git) (MIT)
- [symfony/mailer@v7.1.6](https://github.com/symfony/mailer.git) (MIT)
- [symfony/mime@v7.1.6](https://github.com/symfony/mime.git) (MIT)
...
- [symfony/process@v7.1.6](https://github.com/symfony/process.git) (MIT)
- [symfony/routing@v7.1.6](https://github.com/symfony/routing.git) (MIT)
- [symfony/service-contracts@v3.5.0](https://github.com/symfony/service-contracts.git) (MIT)
- [symfony/string@v7.1.6](https://github.com/symfony/string.git) (MIT)
- [symfony/translation@v7.1.6](https://github.com/symfony/translation.git) (MIT)
- [symfony/translation-contracts@v3.5.0](https://github.com/symfony/translation-contracts.git) (MIT)
- [symfony/uid@v7.1.6](https://github.com/symfony/uid.git) (MIT)
- [symfony/var-dumper@v7.1.6](https://github.com/symfony/var-dumper.git) (MIT)
