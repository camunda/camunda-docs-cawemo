...
- [laravel/framework@v11.41.3](https://github.com/laravel/framework.git) (MIT)
- [laravel/prompts@v0.3.4](https://github.com/laravel/prompts.git) (MIT)
- [laravel/reverb@v1.4.6](https://github.com/laravel/reverb.git) (MIT)
- [laravel/serializable-closure@v2.0.2](https://github.com/laravel/serializable-closure.git) (MIT)
...
- [nesbot/carbon@3.8.4](https://github.com/CarbonPHP/carbon.git) (MIT)
...
- [symfony/error-handler@v7.2.3](https://github.com/symfony/error-handler.git) (MIT)
...
- [symfony/http-kernel@v7.2.3](https://github.com/symfony/http-kernel.git) (MIT)
- [symfony/mailer@v7.2.3](https://github.com/symfony/mailer.git) (MIT)
- [symfony/mime@v7.2.3](https://github.com/symfony/mime.git) (MIT)
