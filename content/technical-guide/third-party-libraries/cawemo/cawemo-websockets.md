...
- [guzzlehttp/guzzle@7.8.0](https://github.com/guzzle/guzzle.git) (MIT)
- [guzzlehttp/promises@2.0.1](https://github.com/guzzle/promises.git) (MIT)
- [guzzlehttp/psr7@2.6.1](https://github.com/guzzle/psr7.git) (MIT)
- [guzzlehttp/uri-template@v1.0.2](https://github.com/guzzle/uri-template.git) (MIT)
- [laravel/framework@v10.30.1](https://github.com/laravel/framework.git) (MIT)
- [laravel/prompts@v0.1.13](https://github.com/laravel/prompts.git) (MIT)
- [laravel/serializable-closure@v1.3.2](https://github.com/laravel/serializable-closure.git) (MIT)
...
- [league/flysystem@3.18.0](https://github.com/thephpleague/flysystem.git) (MIT)
- [league/flysystem-local@3.18.0](https://github.com/thephpleague/flysystem-local.git) (MIT)
- [league/mime-type-detection@1.14.0](https://github.com/thephpleague/mime-type-detection.git) (MIT)
- [monolog/monolog@3.5.0](https://github.com/Seldaek/monolog.git) (MIT)
- [nesbot/carbon@2.71.0](https://github.com/briannesbitt/Carbon.git) (MIT)
- [nette/schema@v1.2.5](https://github.com/nette/schema.git) (BSD-3-Clause)
- [nette/utils@v4.0.3](https://github.com/nette/utils.git) (BSD-3-Clause)
...
- [symfony/console@v6.3.4](https://github.com/symfony/console.git) (MIT)
...
- [symfony/error-handler@v6.3.5](https://github.com/symfony/error-handler.git) (MIT)
...
- [symfony/finder@v6.3.5](https://github.com/symfony/finder.git) (MIT)
- [symfony/http-foundation@v6.3.7](https://github.com/symfony/http-foundation.git) (MIT)
- [symfony/http-kernel@v6.3.7](https://github.com/symfony/http-kernel.git) (MIT)
- [symfony/mailer@v6.3.5](https://github.com/symfony/mailer.git) (MIT)
- [symfony/mime@v6.3.5](https://github.com/symfony/mime.git) (MIT)
...
- [symfony/process@v6.3.4](https://github.com/symfony/process.git) (MIT)
- [symfony/psr-http-message-bridge@v2.3.1](https://github.com/symfony/psr-http-message-bridge.git) (MIT)
- [symfony/routing@v6.3.5](https://github.com/symfony/routing.git) (MIT)
- [symfony/service-contracts@v3.3.0](https://github.com/symfony/service-contracts.git) (MIT)
- [symfony/string@v6.3.5](https://github.com/symfony/string.git) (MIT)
- [symfony/translation@v6.3.7](https://github.com/symfony/translation.git) (MIT)
...
- [symfony/var-dumper@v6.3.6](https://github.com/symfony/var-dumper.git) (MIT)
